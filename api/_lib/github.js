...
/** Reads owner/repo from either query params (GET) or a parsed JSON body (POST). */
function requireRepoParams(source) {
...
module.exports = { GITHUB_API, githubRequest, requireRepoParams };
